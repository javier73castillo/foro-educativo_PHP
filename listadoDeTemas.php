...
try
{
    ...
    //Se crea la instancia de la clase capaTemas y se llama al método que corresponda.
...
if (isset($_SESSION["listado"]) && $_SESSION["listado"] != "")
 	{
 		foreach($_SESSION["listado"] as $val)
        {
            ...
            if ($_SESSION["nb_usuario"] == $val["nb_usuario"])

            {
                echo "<tr><td>".$val['tema']."</td><td>".$val['nb_usuario']."</td><td>".$val['fecha']."</td><td><a href='viewTema.php?idTema=".$val['idtema']."'><img src='imagenes/tema.png' width='30px' height='31px'></a></td><td><a href='delete.php?idtema=".$val['idtema']."'><img src='imagenes/repara.png' width='30px' height='31px'></a></td></tr>";
            }
            else
            {
